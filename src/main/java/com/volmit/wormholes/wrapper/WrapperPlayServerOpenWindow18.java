...
public class WrapperPlayServerOpenWindow18 extends AbstractPacket18 {
    public static final PacketType TYPE = PacketType.Play.Server.OPEN_WINDOW;

    public WrapperPlayServerOpenWindow18() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }

    public WrapperPlayServerOpenWindow18(PacketContainer packet) {
        super(packet, TYPE);
    }
