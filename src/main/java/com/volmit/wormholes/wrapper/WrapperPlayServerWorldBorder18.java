...
public class WrapperPlayServerWorldBorder18 extends AbstractPacket18 {
    public static final PacketType TYPE = PacketType.Play.Server.WORLD_BORDER;

    public WrapperPlayServerWorldBorder18() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }

    public WrapperPlayServerWorldBorder18(PacketContainer packet) {
        super(packet, TYPE);
    }
