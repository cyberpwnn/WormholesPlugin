...
public class WrapperPlayServerAbilities18 extends AbstractPacket18 {
    public static final PacketType TYPE = PacketType.Play.Server.ABILITIES;
    
    public WrapperPlayServerAbilities18() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }
    
    public WrapperPlayServerAbilities18(PacketContainer packet) {
        super(packet, TYPE);
    }
