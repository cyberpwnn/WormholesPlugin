...
public class WrapperPlayServerNamedSoundEffect18 extends AbstractPacket18 {
    public static final PacketType TYPE = PacketType.Play.Server.NAMED_SOUND_EFFECT;
    
    public WrapperPlayServerNamedSoundEffect18() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }
    
    public WrapperPlayServerNamedSoundEffect18(PacketContainer packet) {
        super(packet, TYPE);
    }
