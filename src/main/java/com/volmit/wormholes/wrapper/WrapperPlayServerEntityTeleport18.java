...
public class WrapperPlayServerEntityTeleport18 extends AbstractPacket18 {
    public static final PacketType TYPE = PacketType.Play.Server.ENTITY_TELEPORT;
    
    public WrapperPlayServerEntityTeleport18() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }
    
    public WrapperPlayServerEntityTeleport18(PacketContainer packet) {
        super(packet, TYPE);
    }
