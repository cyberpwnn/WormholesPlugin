...
public class WrapperPlayServerExplosion18 extends AbstractPacket18 {
    public static final PacketType TYPE = PacketType.Play.Server.EXPLOSION;

    public WrapperPlayServerExplosion18() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }

    public WrapperPlayServerExplosion18(PacketContainer packet) {
        super(packet, TYPE);
    }
