...
public class WrapperStatusServerOutServerInfo18 extends AbstractPacket18
{
	@SuppressWarnings("deprecation")
	public static final PacketType TYPE = PacketType.Status.Server.OUT_SERVER_INFO;
	
	public WrapperStatusServerOutServerInfo18()
	{
		super(new PacketContainer(TYPE), TYPE);
		handle.getModifier().writeDefaults();
	}
	
	public WrapperStatusServerOutServerInfo18(PacketContainer packet)
	{
		super(packet, TYPE);
	}
