...
public class WrapperPlayServerSpawnEntity18 extends AbstractPacket18 {
    ...
    public WrapperPlayServerSpawnEntity18() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }

    public WrapperPlayServerSpawnEntity18(PacketContainer packet) {
        super(packet, TYPE);
    }

    public WrapperPlayServerSpawnEntity18(Entity entity, int type, int objectData) {
