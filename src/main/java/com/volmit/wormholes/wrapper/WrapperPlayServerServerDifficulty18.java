...
public class WrapperPlayServerServerDifficulty18 extends AbstractPacket18 {
    public static final PacketType TYPE = PacketType.Play.Server.SERVER_DIFFICULTY;
    
    public WrapperPlayServerServerDifficulty18() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }
    
    public WrapperPlayServerServerDifficulty18(PacketContainer packet) {
        super(packet, TYPE);
    }
