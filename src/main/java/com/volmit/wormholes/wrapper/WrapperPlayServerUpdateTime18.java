...
public class WrapperPlayServerUpdateTime18 extends AbstractPacket18 {
    public static final PacketType TYPE = PacketType.Play.Server.UPDATE_TIME;
    
    public WrapperPlayServerUpdateTime18() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }
    
    public WrapperPlayServerUpdateTime18(PacketContainer packet) {
        super(packet, TYPE);
    }
