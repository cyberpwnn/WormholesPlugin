...
public class WrapperPlayServerSetCompression18 extends AbstractPacket18
{
	@SuppressWarnings("deprecation")
	public static final PacketType TYPE = PacketType.Play.Server.SET_COMPRESSION;
	
	public WrapperPlayServerSetCompression18()
	{
		super(new PacketContainer(TYPE), TYPE);
		handle.getModifier().writeDefaults();
	}
	
	public WrapperPlayServerSetCompression18(PacketContainer packet)
	{
		super(packet, TYPE);
	}
