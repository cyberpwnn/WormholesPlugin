...
public class WrapperLoginServerEncryptionBegin18 extends AbstractPacket18 {
    public static final PacketType TYPE = PacketType.Login.Server.ENCRYPTION_BEGIN;
    
    public WrapperLoginServerEncryptionBegin18() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }
    
    public WrapperLoginServerEncryptionBegin18(PacketContainer packet) {
        super(packet, TYPE);
    }
