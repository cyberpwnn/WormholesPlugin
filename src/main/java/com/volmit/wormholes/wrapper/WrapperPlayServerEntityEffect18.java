...
public class WrapperPlayServerEntityEffect18 extends AbstractPacket18 {
    public static final PacketType TYPE = PacketType.Play.Server.ENTITY_EFFECT;
    
    public WrapperPlayServerEntityEffect18() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }
    
    public WrapperPlayServerEntityEffect18(PacketContainer packet) {
        super(packet, TYPE);
    }
