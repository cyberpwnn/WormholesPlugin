...
public class WrapperPlayServerTileEntityData18 extends AbstractPacket18 {
    public static final PacketType TYPE = PacketType.Play.Server.TILE_ENTITY_DATA;
    
    public WrapperPlayServerTileEntityData18() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }
    
    public WrapperPlayServerTileEntityData18(PacketContainer packet) {
        super(packet, TYPE);
    }
