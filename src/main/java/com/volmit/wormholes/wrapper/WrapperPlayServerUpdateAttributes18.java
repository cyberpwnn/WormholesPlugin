...
public class WrapperPlayServerUpdateAttributes18 extends AbstractPacket18 {
    public static final PacketType TYPE = PacketType.Play.Server.UPDATE_ATTRIBUTES;

    public WrapperPlayServerUpdateAttributes18() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }

    public WrapperPlayServerUpdateAttributes18(PacketContainer packet) {
        super(packet, TYPE);
    }
