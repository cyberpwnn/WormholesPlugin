...
public class WrapperPlayServerMultiBlockChange18 extends AbstractPacket18 {
    public static final PacketType TYPE = PacketType.Play.Server.MULTI_BLOCK_CHANGE;
    
    public WrapperPlayServerMultiBlockChange18() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }
    
    public WrapperPlayServerMultiBlockChange18(PacketContainer packet) {
        super(packet, TYPE);
    }
