...
public class WrapperLoginServerSuccess18 extends AbstractPacket18 {
    public static final PacketType TYPE = PacketType.Login.Server.SUCCESS;
    
    public WrapperLoginServerSuccess18() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }
    
    public WrapperLoginServerSuccess18(PacketContainer packet) {
        super(packet, TYPE);
    }
