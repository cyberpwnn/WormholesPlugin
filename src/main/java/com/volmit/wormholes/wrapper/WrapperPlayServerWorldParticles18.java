...
public class WrapperPlayServerWorldParticles18 extends AbstractPacket18 {
    public static final PacketType TYPE = PacketType.Play.Server.WORLD_PARTICLES;

    public WrapperPlayServerWorldParticles18() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }

    public WrapperPlayServerWorldParticles18(PacketContainer packet) {
        super(packet, TYPE);
    }
