...
public class WrapperPlayServerRespawn18 extends AbstractPacket18 {
    public static final PacketType TYPE = PacketType.Play.Server.RESPAWN;
    
    public WrapperPlayServerRespawn18() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }
    
    public WrapperPlayServerRespawn18(PacketContainer packet) {
        super(packet, TYPE);
    }
