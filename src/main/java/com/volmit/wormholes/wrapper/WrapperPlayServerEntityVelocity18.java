...
public class WrapperPlayServerEntityVelocity18 extends AbstractPacket18 {
    public static final PacketType TYPE = PacketType.Play.Server.ENTITY_VELOCITY;

    public WrapperPlayServerEntityVelocity18() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }

    public WrapperPlayServerEntityVelocity18(PacketContainer packet) {
        super(packet, TYPE);
    }
