...
public class WrapperPlayClientBlockPlace18 extends AbstractPacket18 {
    public static final PacketType TYPE = PacketType.Play.Client.BLOCK_PLACE;
    
    public WrapperPlayClientBlockPlace18() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }
    
    public WrapperPlayClientBlockPlace18(PacketContainer packet) {
        super(packet, TYPE);
    }
