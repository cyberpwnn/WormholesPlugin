...
public class WrapperPlayServerCombatEvent18 extends AbstractPacket18 {
    public static final PacketType TYPE = PacketType.Play.Server.COMBAT_EVENT;

    public WrapperPlayServerCombatEvent18() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }

    public WrapperPlayServerCombatEvent18(PacketContainer packet) {
        super(packet, TYPE);
    }
