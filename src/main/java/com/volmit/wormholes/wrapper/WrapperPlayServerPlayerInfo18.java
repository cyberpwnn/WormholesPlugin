...
public class WrapperPlayServerPlayerInfo18 extends AbstractPacket18 {
    public static final PacketType TYPE = PacketType.Play.Server.PLAYER_INFO;
    
    public WrapperPlayServerPlayerInfo18() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }
    
    public WrapperPlayServerPlayerInfo18(PacketContainer packet) {
        super(packet, TYPE);
    }
