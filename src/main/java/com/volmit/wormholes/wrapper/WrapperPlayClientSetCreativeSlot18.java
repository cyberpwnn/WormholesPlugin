...
public class WrapperPlayClientSetCreativeSlot18 extends AbstractPacket18 {
    public static final PacketType TYPE = PacketType.Play.Client.SET_CREATIVE_SLOT;
    
    public WrapperPlayClientSetCreativeSlot18() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }
    
    public WrapperPlayClientSetCreativeSlot18(PacketContainer packet) {
        super(packet, TYPE);
    }
