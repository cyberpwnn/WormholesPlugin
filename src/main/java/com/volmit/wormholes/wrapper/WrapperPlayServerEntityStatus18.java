...
public class WrapperPlayServerEntityStatus18 extends AbstractPacket18 {
    public static final PacketType TYPE = PacketType.Play.Server.ENTITY_STATUS;

    public WrapperPlayServerEntityStatus18() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }

    public WrapperPlayServerEntityStatus18(PacketContainer packet) {
        super(packet, TYPE);
    }
