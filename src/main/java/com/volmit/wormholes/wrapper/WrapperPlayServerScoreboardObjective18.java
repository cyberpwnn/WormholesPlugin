...
public class WrapperPlayServerScoreboardObjective18 extends AbstractPacket18 {
    public static final PacketType TYPE = PacketType.Play.Server.SCOREBOARD_OBJECTIVE;
    
    public WrapperPlayServerScoreboardObjective18() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }
    
    public WrapperPlayServerScoreboardObjective18(PacketContainer packet) {
        super(packet, TYPE);
    }
