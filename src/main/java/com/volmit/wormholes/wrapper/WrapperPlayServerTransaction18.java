...
public class WrapperPlayServerTransaction18 extends AbstractPacket18 {
    public static final PacketType TYPE = PacketType.Play.Server.TRANSACTION;
    
    public WrapperPlayServerTransaction18() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }
    
    public WrapperPlayServerTransaction18(PacketContainer packet) {
        super(packet, TYPE);
    }
