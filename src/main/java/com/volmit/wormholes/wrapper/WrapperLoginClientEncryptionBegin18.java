...
public class WrapperLoginClientEncryptionBegin18 extends AbstractPacket18 {
    public static final PacketType TYPE = PacketType.Login.Client.ENCRYPTION_BEGIN;
    
    public WrapperLoginClientEncryptionBegin18() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }
    
    public WrapperLoginClientEncryptionBegin18(PacketContainer packet) {
        super(packet, TYPE);
    }
