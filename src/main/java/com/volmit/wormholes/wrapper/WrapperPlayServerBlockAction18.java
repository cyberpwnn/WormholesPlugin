...
public class WrapperPlayServerBlockAction18 extends AbstractPacket18 {
    public static final PacketType TYPE = PacketType.Play.Server.BLOCK_ACTION;
    
    public WrapperPlayServerBlockAction18() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }
    
    public WrapperPlayServerBlockAction18(PacketContainer packet) {
        super(packet, TYPE);
    }
