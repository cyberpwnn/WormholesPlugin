...
public class WrapperPlayServerEntityMoveLook18 extends AbstractPacket18
{
	@SuppressWarnings("deprecation")
	public static final PacketType TYPE = PacketType.Play.Server.ENTITY_MOVE_LOOK;
	
	public WrapperPlayServerEntityMoveLook18()
	{
		super(new PacketContainer(TYPE), TYPE);
		handle.getModifier().writeDefaults();
	}
	
	public WrapperPlayServerEntityMoveLook18(PacketContainer packet)
	{
		super(packet, TYPE);
	}
