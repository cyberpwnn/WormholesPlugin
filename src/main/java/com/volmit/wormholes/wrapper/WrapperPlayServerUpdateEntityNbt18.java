...
public class WrapperPlayServerUpdateEntityNbt18 extends AbstractPacket18
{
	@SuppressWarnings("deprecation")
	public static final PacketType TYPE = PacketType.Play.Server.UPDATE_ENTITY_NBT;
	
	public WrapperPlayServerUpdateEntityNbt18()
	{
		super(new PacketContainer(TYPE), TYPE);
		handle.getModifier().writeDefaults();
	}
	
	public WrapperPlayServerUpdateEntityNbt18(PacketContainer packet)
	{
		super(packet, TYPE);
	}
