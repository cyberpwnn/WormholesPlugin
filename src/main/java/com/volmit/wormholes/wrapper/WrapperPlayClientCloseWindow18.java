...
public class WrapperPlayClientCloseWindow18 extends AbstractPacket18 {
    public static final PacketType TYPE = PacketType.Play.Client.CLOSE_WINDOW;
    
    public WrapperPlayClientCloseWindow18() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }
    
    public WrapperPlayClientCloseWindow18(PacketContainer packet) {
        super(packet, TYPE);
    }
