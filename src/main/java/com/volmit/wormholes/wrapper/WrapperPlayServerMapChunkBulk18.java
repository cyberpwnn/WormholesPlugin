...
public class WrapperPlayServerMapChunkBulk18 extends AbstractPacket18
{
	@SuppressWarnings("deprecation")
	public static final PacketType TYPE = PacketType.Play.Server.MAP_CHUNK_BULK;
	
	public WrapperPlayServerMapChunkBulk18()
	{
		super(new PacketContainer(TYPE), TYPE);
		handle.getModifier().writeDefaults();
	}
	
	public WrapperPlayServerMapChunkBulk18(PacketContainer packet)
	{
		super(packet, TYPE);
	}
	 ...
	 * <p>
	 * Notes: whether or not the chunk data contains a light nibble array. This
	 * is true in the main world, false in the end + nether
	 * 
