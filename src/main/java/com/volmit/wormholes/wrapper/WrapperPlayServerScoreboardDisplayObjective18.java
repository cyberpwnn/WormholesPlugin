...
public class WrapperPlayServerScoreboardDisplayObjective18 extends AbstractPacket18 {
    public static final PacketType TYPE = PacketType.Play.Server.SCOREBOARD_DISPLAY_OBJECTIVE;
    
    public WrapperPlayServerScoreboardDisplayObjective18() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }
    
    public WrapperPlayServerScoreboardDisplayObjective18(PacketContainer packet) {
        super(packet, TYPE);
    }
