...
public class WrapperPlayServerCamera18 extends AbstractPacket18 {
    public static final PacketType TYPE = PacketType.Play.Server.CAMERA;
    
    public WrapperPlayServerCamera18() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }
    
    public WrapperPlayServerCamera18(PacketContainer packet) {
        super(packet, TYPE);
    }
