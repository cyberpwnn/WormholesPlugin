...
public class WrapperPlayServerKickDisconnect18 extends AbstractPacket18 {
    public static final PacketType TYPE = PacketType.Play.Server.KICK_DISCONNECT;
    
    public WrapperPlayServerKickDisconnect18() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }
    
    public WrapperPlayServerKickDisconnect18(PacketContainer packet) {
        super(packet, TYPE);
    }
