...
public class WrapperPlayServerMapChunk18 extends AbstractPacket18 {
    public static final PacketType TYPE = PacketType.Play.Server.MAP_CHUNK;

    public WrapperPlayServerMapChunk18() {
        super(new PacketContainer(TYPE), TYPE);
        handle.getModifier().writeDefaults();
    }

    public WrapperPlayServerMapChunk18(PacketContainer packet) {
        super(packet, TYPE);
    }
