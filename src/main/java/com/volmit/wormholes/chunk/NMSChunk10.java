...
public class NMSChunk10 extends NMSChunk implements VirtualChunk
{
	private net.minecraft.server.v1_10_R1.Chunk nmsChunk;
	
	public NMSChunk10(Chunk bukkitChunk) throws NMSChunkFailureException
	{
		super(bukkitChunk, "1_10_R1");
