...
public class J
{
	...
	{
		Bukkit.getScheduler().scheduleSyncDelayedTask(Wormholes.instance, r);
	}
	...
	{
		Bukkit.getScheduler().scheduleSyncDelayedTask(Wormholes.instance, r, delay);
	}
	...
	{
		return Bukkit.getScheduler().scheduleSyncRepeatingTask(Wormholes.instance, r, 0, interval);
	}
	...
	{
		Bukkit.getScheduler().scheduleAsyncDelayedTask(Wormholes.instance, r, 0);
	}
	...
	{
		Bukkit.getScheduler().scheduleAsyncDelayedTask(Wormholes.instance, r, delay);
	}
	...
	{
		return Bukkit.getScheduler().scheduleAsyncRepeatingTask(Wormholes.instance, r, 0, interval);
	}
